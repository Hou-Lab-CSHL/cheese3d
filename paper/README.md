...
|:--------------------:|:---------|:------------|
| <img src="Fig1Example.png" width=200> | `fig1-cheese3d-accuracy.ipynb` | Framework and validation of capturing face-wide movement as 3D geometric features in mice |
...
| <img src="Fig4Example.png" width=200> | `fig4-cheese3d-chewing-whole-face-kinematics.ipynb` | Chewing kinematics in mouth and surrounding facial areas |
